...
import { UpdateItemQuantityRequestDto } from './update-item-quantity.request.dto';
import { UpdateItemQuantityServiceResult } from './update-item-quantity.service';
...
export class UpdateItemQuantityHttpController {
  constructor(
  ...
  async create(
    ...
    const result: UpdateItemQuantityServiceResult =
